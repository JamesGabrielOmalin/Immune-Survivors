...
public partial class @PlayerInputControls: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerInputControls()
    {
        UnityEngine.Debug.Assert(!m_Movement.enabled, "This will cause a leak and performance issues, PlayerInputControls.Movement.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Abilities.enabled, "This will cause a leak and performance issues, PlayerInputControls.Abilities.Disable() has not been called.");
    }
